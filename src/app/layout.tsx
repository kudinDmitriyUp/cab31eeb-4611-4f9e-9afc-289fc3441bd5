...
export const metadata: Metadata = {
  title: "Idanzito - Restaurante y Hotel de Lujo en España",
  description: "Experiencia gastronómica excepcional y alojamiento de lujo en España. Descubre Idanzito, donde la tradición culinaria se encuentra con la elegancia moderna.",
  keywords: ["hotel lujo España", "restaurante premium", "gastronomía española", "alojamiento exclusivo", "spa wellness", "experiencias culinarias"],
  metadataBase: new URL("https://idanzito.com"),
  alternates: {
    canonical: "https://idanzito.com"
  },
  openGraph: {
    title: "Idanzito - Restaurante y Hotel de Lujo en España",
    description: "Experiencia gastronómica excepcional y alojamiento de lujo en España. Tradición culinaria y elegancia moderna.",
    url: "https://idanzito.com",
    siteName: "Idanzito",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763634212129-m6i16krc.jpg",
        alt: "Hotel Idanzito - Restaurante de lujo en España"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Idanzito - Restaurante y Hotel de Lujo en España",
    description: "Experiencia gastronómica excepcional y alojamiento de lujo en España",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763634212129-m6i16krc.jpg"]
  },
  robots: {
    index: true,
    follow: true
